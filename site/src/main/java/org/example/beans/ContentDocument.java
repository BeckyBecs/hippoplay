...
@HippoEssentialsGenerated(internalName = "hippoplay:contentdocument")
@Node(jcrType = "hippoplay:contentdocument")
public class ContentDocument extends BaseDocument {
    @HippoEssentialsGenerated(internalName = "hippoplay:introduction")
    public String getIntroduction() {
        return getProperty("hippoplay:introduction");
    }
    ...
    @HippoEssentialsGenerated(internalName = "hippoplay:publicationdate")
    public Calendar getPublicationDate() {
        return getProperty("hippoplay:publicationdate");
    }
}
